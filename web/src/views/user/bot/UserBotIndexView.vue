                            ...
                            <div class="modal-dialog modal-xl">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <VAceEditor @init="editorInit" lang="c_cpp" v-model:value="botadd.content" :options="{
                                                    ...
                                                    }"  theme="monokai" style="height: 400px" />                                  
                                    </div>
                                </div>
                                            ...
                                            <div class="modal-dialog modal-xl">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <VAceEditor @init="editorInit" lang="c_cpp" v-model:value="bot.content" :options="{
                                                            enableBasicAutocompletion: true, //启用基本自动完成
                                                            enableSnippets: true, // 启用代码段
                                                            enableLiveAutocompletion: true, // 启用实时自动完成
                                                            fontSize: 18, //设置字号
...
///上面的都是基础配置
import '../../../../ace.config'; // 主要是引入这个前面写的配置文件
